[![Run App Trevor Hoffman](https://github.com/thoffman13/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/thoffman13/GithubActions/actions/workflows/run-app.yaml)
